package com.awsworkspace.s3work.service;
...
public class BucketServiceImpl implements BucketService {
    ...
    public void getObjectFromBucket(String bucketName, String objectName) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream(new File("E:\\awspratice\\s3work\\src\\main\\resources\\outputfiles\\"+objectName));
